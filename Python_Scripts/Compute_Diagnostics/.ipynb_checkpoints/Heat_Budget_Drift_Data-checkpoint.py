...
This script computes heat budget terms using temperature and velocity data for drift trend data. 
...
data_dir="/gws/nopw/j04/snapdragon/hkhatri/Data_Drift/"
save_path="/gws/nopw/j04/snapdragon/hkhatri/Data_Drift/Heat_Budget/"
...
# Loop for going through multiple ensemble drift data for computations
for r in range(0,10):
    ...
    for lead_year in range(0,11):
        ...
        for var in var_list:
            ...
            var_path = (data_dir + var + "/Drift_" + var + "_r" + str(r+1) + 
                        "_Lead_Year_" + str(lead_year+1) + ".nc")

            d = xr.open_dataset(var_path, chunks={'time':1}, engine='netcdf4')
            ...
            if(var == 'vo'):
                ...
                d = d.rename({'i':'i_c', 'longitude':'longitcdude_u', 'latitude':'latitude_u'})
            elif(var == 'wo'):
        ...
        save_file_path = (save_path + "Heat_Budget" + "_r" + str(r+1) + "_Lead_Year_" + str(lead_year+1) + ".nc")
