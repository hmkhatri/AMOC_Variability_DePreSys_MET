...
year1, year2 = (2000, 2017) # range over to compute average using DCPP 2016 paper
...
for var in var_list:
    ...
    for r in range(4,5):
        ...
        for year in range(year1-10, year2, 1):
            ...
            d = d.isel(i=slice(749,1199), j = slice(699, 1149), lev=0)
        ...
        #if(var=='thetao'):
        #ds = ds.chunk({'start_year':1, 'time':12, 'lev':1})
        #else:
        ds = ds.chunk({'start_year':1, 'time':12, 'j':50})
